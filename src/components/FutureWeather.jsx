    ...
    return (
        <Card className="col-span-12 justify-start lg:col-span-4 row-span-8 row-start-5 md:col-span-6 col-start-1">
            ...
            <div className="flex flex-col  h-full mt-5 justify-between">
                {
                    todayWeather?.map((weather, i,arr) => (
                        <div key={i} className={`py-2 flex items-center w-full ${i===0&&"border-b"} ${i!==0&&i!==arr.length-1&&"border-b"} justify-between`}>
                            ...
                            <div className="flex items-center justify-between text-[12px] gap-2">
                                ...
                                <div className="h-[5px] max-w-[150px] bg-linear-to-r from-teal-400 rounded-full to-orange-400 w-[150px]"></div>
